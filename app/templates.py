...
SAFE_MODULES: Dict[str, List[str]] = {
    "cooperative": [
        "Okay, I want to follow the correct steps. Which {channels} should I use?",
        "I will do it, but please confirm the official {forms} first.",
        "Please guide me step by step so I do it correctly.",
        "I am ready to proceed. What is the official process?",
    ],
    "clarification": [
